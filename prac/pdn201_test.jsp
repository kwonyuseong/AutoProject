...
//		disabledButton(form);
	...
	//ページリスト
	function pageList_click(int arginputNo) {
		var form = document.Pdn201Form;
		disabledButton(form);
		form.formaction.value = "movepage";
		form.
		form.target = "_self";
		form.submit();
	}
	...
	<TABLE class="TableMain" style="margin-top:2px;width:1000px;">
		...
		<TR>
			...
			<TD class="Td3" style="width:200px;" title=<bean:write name="Pdn201Form" property="sitecode" />>
				<select name="sitecode" class="Select_full" >
					<logic:notEmpty name="Pdn201Form" property="sitecode">
						<option value="test" selected="selected">test</option>
					</logic:notEmpty>
					<logic:empty name="Pdn201Form" property="sitecode">
						<option value="" selected="selected">emptyTest</option>
					</logic:empty>
					<option value="8M ">8M:ＤＩＳＣＯ</option>
					<option value="8Q">8Q:ＤＩＳＣＯ（杵築）</option>
				    <option value="AJ">AJ:ミハラ</option>
				    <option value="AK ">AK:カンダ</option>
				    <option value="AL">AL:野毛</option>
				    <option value="AM">AM:KEDC</option>
				    <option value="B4">B4:春江電子</option>
				    <option value="J1">J1:福岡製</option>
				    <option value="J2">J2:杵製</option>
				    <option value="J5">J5:臼製</option>
				    <option value="J8">J8:WT製B/D </option>
				    <option value="JE">JE:(会品１）</option>
				    <option value="JG">JG:熊本大津</option>
				    <option value="JH">JH:福井製</option>
				    <option value="JK">JK:スズキ(杵築)</option>
				    <option value="JO">JO:Ｔ技５</option>
				    <option value="JW">JW:（Ｐ技７）</option>
				    <option value="K8">K8:（品２Ｇ）</option>
				    <option value="KA">KA:Ａ技１）</option>
				    <option value="KD">KD:（Ａ技２）</option>
				    <option value="KE">KE:（Ｔ技２）</option>
				    <option value="KG">KG:（Ａ技３）</option>
				    <option value="KT">KT:（生１Ｇ）</option>
				    <option value="KX">KX:（品証6）</option>
				    <option value="KZ">KZ:（品証8）</option>
				    <option value="L2">L2:（ＩＳＧ）</option>
				    <option value="LB">LB:（Ｔ技6）</option>
				    <option value="UN">UN:ｸﾏﾓﾄﾎﾞｳｾｲ</option>
				</select>
